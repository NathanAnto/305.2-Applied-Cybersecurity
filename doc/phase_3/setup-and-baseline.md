...
- **This file** (`phase_3.md`) — VM setup, Ubuntu install, Secure Boot checks, and the "before" snapshot of the current UEFI keys.
...
- **Hypervisor:** VirtualBox 7.2.6 (guncel surum, UEFI ve TPM destegi var)
- **Guest OS:** Ubuntu 24.04 LTS
- **Limitation:** VirtualBox 7.2.6'da custom Secure Boot key enrollment sinirli. PK/KEK/db'yi UEFI menusunden yuklemek icin gereken arayuz tam olarak yok ya da gomulu. ([VirtualBox ticket #21848 — "Enrolling of custom Secure Boot keys generated by Linux fails"](https://www.virtualbox.org/ticket/21848))
