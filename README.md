...
Full Disk Encryption (FDE) is a security strategy that protects data by 
encrypting every bit of information on a storage medium (operating system, user files, swap space, and metadata).
